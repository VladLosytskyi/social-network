...
const Users = props => {
  ...
  return (
    <section>
      <button onClick={ getUsers } className={ classes.whiteButton }>Get Users</button>
      {
          ...
          <div className={ classes.user }>
            <div className={ classes.userImage }>
              ...
              <div>
                {
                  user.followed
                    ? <button onClick={ () => props.unfollow(user.id) } className={ classes.whiteButton }>Unfollow</button>
                    : <button onClick={ () => props.follow(user.id) } className={ classes.blueButton }>Follow</button>
                }
              </div>
            </div>
